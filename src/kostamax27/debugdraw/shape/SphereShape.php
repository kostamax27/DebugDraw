...
/**
 * A sphere centered at $location.
 */
final readonly class SphereShape implements Shape{
	use ShapeTrait;
	...
	public function toPacketData(int $network_id) : PacketShapeData{
		return $this->createPacketData($network_id, PrimitiveShapeType::SPHERE, new PrimitiveShapeCircleOrSpherePayload($this->segments));
	}
}
